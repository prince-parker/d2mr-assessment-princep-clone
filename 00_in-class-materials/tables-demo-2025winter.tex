...
[!h]
\centering
\caption{\label{tab:tbl-hold-position}Table will appear exactly where you call it.}
\centering
...
[!h]
\centering
\caption{\label{tab:tbl-size-scaledown}When you have a wide table that will normally go out of the page, and you want to scale down the table to fit the page, you can use the scale down option.}
\centering
...
[!h]
\centering
\caption{\label{tab:tbl-size-scaleup}Use the scale up option to stretch to full page width.}
\centering
\resizebox{\ifdim\width<\linewidth\linewidth\else\width\fi}{!}{
\begin{tabular}[t]{l|r|r|r|r|r|r}
\hline
...
\caption{\label{tab:tbl-alignleft}Align your table (not the text, the whole table), 'left' or 'center' (the default) with the position argument.}
\begin{tabular}[t]{l|r|r|r|r|r|r}
\hline
  & mpg & cyl & disp & hp & drat & wt\\
\hline
...
\centering
\caption{\label{tab:tbl-col-specs}This table uses column specifications to make many visual modifications to individual rows. The final line shows how the same function can modify just one cell in a column in a similar way.}
\centering
...
\centering
\caption{\label{tab:tbl-row-specs}You can specify styling for rows in the same way.}
\centering
...
[!h]
\centering
\caption{\label{tab:tbl-grouping-addheader}Create grouped columns by adding a header.}
\centering
\begin{tabular}[t]{l|r|r|r|r|r|r}
\hline
...
[!h]
\centering
\caption{\label{tab:tbl-grouping-multiple}Group multiple times and format these header rows individually.}
\centering
\begin{tabular}[t]{l|r|r|r|r|r|r}
\hline
...
[!h]
\centering
\caption{\label{tab:tbl-grouping-packrows}Group rows using packing.}
\centering
\begin{tabular}[t]{l|r|r|r|r|r|r}
\hline
  & mpg & cyl & disp & hp & drat & wt\\
...
\caption{\label{tab:tbl-grouping-collapse}Collapse rows for more of a 'merge cells' effect.}
\centering
...
\centering
\caption{\label{tab:tbl-footnotes}Add unordered (general) and ordered footnotes.}
\centering
